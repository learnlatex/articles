...
is that it does not directly return the generated \acro{PDF} but returns a
call to a locally hosted copy of the
\href{https://mozilla.github.io/pdf.js/}{\acro{PDF}.js}
...
The server supports options to return the \acro{PDF} directly, or to return
...
such images, which are based on \acro{GNU}/Linux and ship with all required
